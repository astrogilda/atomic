...
pub use traits::{
    ...
    GitShaIndexMutTxnT, GitShaIndexTxnT, GraphTxnT, KgMutTxnT, KgTxnT, MutTxnT, PatchRelinkTarget,
    PatchRelinkTxnT, StoredConflict, StoredConflictKind, TagKind, TagMutTxnT, TagRecord, TagTxnT,
    TreeTxnT, VaultEntryMeta, VaultMutTxnT, VaultTxnT, VertexExt, ViewScope, ViewState, ViewTxnT,
};
